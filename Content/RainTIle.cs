...
namespace RainOverhaul.Content {
    public class RainTile {
        /// <summary>
		/// Use this if you need to get tile state. If true, tile can protect enitiy from the rain.
		/// </summary>
        public static bool CanProtect(Tile tTile) {
            return 
            ...
            tTile.TileType!=TileID.WebRope&&tTile.TileType!=TileID.WorkBenches;
        }
    }
}